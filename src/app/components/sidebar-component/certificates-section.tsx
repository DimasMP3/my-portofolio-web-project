...
export function CertificatesSection() {
  ...
  const [certificates, setCertificates] = useState([
    ...
    },
    {
      ...
      date: "2025",
      description: "A fundamental introduction to software engineering concepts and practices.",
      skills: ["Html", "CSS", "JavaScript", "Git"],
      link: "https://drive.google.com/file/d/1ytNAa1KYw6EXluFzgRonQe_en7A_E3SS/view?usp=sharing",
